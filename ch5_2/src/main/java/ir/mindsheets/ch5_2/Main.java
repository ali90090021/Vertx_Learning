...
public class Main extends AbstractVerticle {
  ...
  public static void main(String[] args) {
    ...
    vertx.deployVerticle("ir.mindsheets.ch5_2.HeatSensor",
    ...
    vertx.deployVerticle("ir.mindsheets.ch5_2.SnapshotService");
    vertx.deployVerticle("ir.mindsheets.ch5_2.CollectorService");
